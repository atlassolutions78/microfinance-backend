...
| id_number            | text                 |                                         |
| matriculation_number | text                 | nullable                                |
| is_minor             | boolean              |                                         |
...
#### `representatives` — mandataires for individual clients
...
#### `organization_representatives` — signatories for organization clients
...
| --------------------- | -------------------------------------- | ------------------------------- |
| id                    | uuid PK                                |                                 |
| org_representative_id | uuid FK → organization_representatives |                                 |
| document_type         | enum                                   | `PASSPORT_PHOTO` `ID_DOCUMENT`  |
| file_name             | text                                   |                                 |
| file_url              | text                                   |                                 |
| status                | enum                                   | `PENDING` `ACCEPTED` `REJECTED` |
