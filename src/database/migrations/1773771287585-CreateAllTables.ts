...
export class CreateAllTables1773771287585 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('TELLER', 'LOAN_OFFICER', 'MANAGER', 'ADMIN')`);
        ...
        await queryRunner.query(`CREATE TABLE "branches" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "address" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_7f37d3b42defea97f1df0d19535" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."client_documents_document_type_enum" AS ENUM('PASSPORT_PHOTO', 'ID_DOCUMENT', 'REGISTRATION_DOC', 'OPENING_LETTER', 'BIOMETRIC')`);
        await queryRunner.query(`CREATE TYPE "public"."client_documents_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."representative_documents_document_type_enum" AS ENUM('PASSPORT_PHOTO', 'ID_DOCUMENT', 'REPRESENTATIVE_ID')`);
        await queryRunner.query(`CREATE TYPE "public"."representative_documents_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "representative_documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "representative_id" uuid NOT NULL, "document_type" "public"."representative_documents_document_type_enum" NOT NULL, "file_name" text NOT NULL, "file_url" text NOT NULL, "status" "public"."representative_documents_status_enum" NOT NULL DEFAULT 'PENDING', "rejection_reason" text, "uploaded_by" uuid NOT NULL, "reviewed_by" uuid, "reviewed_at" TIMESTAMP WITH TIME ZONE, "uploaded_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f11c01254bb802ce2f8c75a5179" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."guardian_documents_document_type_enum" AS ENUM('PASSPORT_PHOTO', 'ID_DOCUMENT')`);
        await queryRunner.query(`CREATE TYPE "public"."guardian_documents_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "guardian_documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "guardian_id" uuid NOT NULL, "document_type" "public"."guardian_documents_document_type_enum" NOT NULL, "file_name" text NOT NULL, "file_url" text NOT NULL, "status" "public"."guardian_documents_status_enum" NOT NULL DEFAULT 'PENDING', "rejection_reason" text, "uploaded_by" uuid NOT NULL, "reviewed_by" uuid, "reviewed_at" TIMESTAMP WITH TIME ZONE, "uploaded_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_ae7f23b896b2103c6c63a36de12" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."clients_type_enum" AS ENUM('INDIVIDUAL', 'BUSINESS')`);
        await queryRunner.query(`CREATE TYPE "public"."clients_kyc_status_enum" AS ENUM('PENDING', 'UNDER_REVIEW', 'APPROVED', 'REJECTED', 'REQUIRES_UPDATE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."individual_profiles_gender_enum" AS ENUM('MALE', 'FEMALE', 'OTHER')`);
        await queryRunner.query(`CREATE TYPE "public"."individual_profiles_marital_status_enum" AS ENUM('SINGLE', 'MARRIED', 'DIVORCED', 'WIDOWED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."representatives_signatory_type_enum" AS ENUM('MANDATORY', 'OPTIONAL')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."representatives_signatory_type_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."individual_profiles_marital_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."individual_profiles_gender_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."guardian_documents_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."guardian_documents_document_type_enum"`);
        await queryRunner.query(`DROP TABLE "representative_documents"`);
        await queryRunner.query(`DROP TYPE "public"."representative_documents_status_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."client_documents_status_enum"`);
